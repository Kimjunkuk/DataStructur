...
void moveMouse(mouseType* Mouse)
{
	switch (Mouse->dir)
	{
		case 0 : Mouse->y++; break; // 동으로 이동
		case 1 : Mouse->x++; break; // 남으로 이동
		case 2 : Mouse->y--; break; // 서로 이동
		case 3 : Mouse->x--; break; // 북으로 이동
	}
...
int movePossible(int x, int y, int direction)
{
	switch (direction)
	{
		case 0: y++; break; // 동으로 이동
		case 1: x++; break; // 남으로 이동
		case 2: y--; break; // 서로 이동
		case 3: x--; break; // 북으로 이동
	}
